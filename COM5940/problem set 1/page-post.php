        ...
        <main class="post blog-post col-lg-8">
          <div class="container">
            <div class="post-single">
              <div class="post-thumbnail"><img src="<?php bloginfo("template_url")?>/img/blog-post-3.jpeg" alt="..." class="img-fluid"></div>
              <div class="post-details">
                ...
                <div class="post-body">
                  ...
                  <p> <img src="<?php bloginfo("template_url")?>/img/featured-pic-3.jpeg" alt="..." class="img-fluid"></p>
                  ...
                  <div class="comment">
                    <div class="comment-header d-flex justify-content-between">
                      <div class="user d-flex align-items-center">
                        <div class="image"><img src="<?php bloginfo("template_url")?>/img/user.svg" alt="..." class="img-fluid rounded-circle"></div>
        ...
        <aside class="col-lg-4">
          ...
          <div class="widget latest-posts">
            ...
            <div class="blog-posts"><a href="#">
                ...
                <div class="item d-flex align-items-center">
                  <div class="image"><img src="<?php bloginfo("template_url")?>/img/small-thumbnail-2.jpg" alt="..." class="img-fluid"></div>
                  <div class="title"><strong>Alberto Savoia Can Teach You About</strong>
                    <div class="d-flex align-items-center">
                      <div class="views"><i class="icon-eye"></i> 500</div>
                      <div class="comments"><i class="icon-comment"></i>12</div>
                ...
                <div class="item d-flex align-items-center">
                  <div class="image"><img src="<?php bloginfo("template_url")?>/img/small-thumbnail-3.jpg" alt="..." class="img-fluid"></div>
                  <div class="title"><strong>Alberto Savoia Can Teach You About</strong>
                    <div class="d-flex align-items-center">
                      <div class="views"><i class="icon-eye"></i> 500</div>
                      <div class="comments"><i class="icon-comment"></i>12</div>
